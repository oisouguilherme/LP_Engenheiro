...
import ImageCasa from "../../assets/casa1.webp";
export function ProjetosImages() {
  return (
    <div id="Projetos">
      <h2 className="text-center text-3xl font-semibold bg-[url('/bgMarmore.webp')] py-12">
        PROJETOS
      </h2>
      <div className="max-w-6xl mx-auto flex flex-wrap gap-2 justify-center py-12">
        <Image
          src={ImageCasa}
      ...
      <div className="flex justify-around flex-wrap max-w-6xl mx-auto">
        ...
        <div className="flex gap-2 items-center">
          ...
          <div className="text-zinc-600 text-sm">
            <p>Onde estou</p>
            <p>Rua Rio Grande do Norte, 59</p>
            <p>Buritis, MG</p>
          </div>
        </div>
      </div>
